package com.selwan.schools365teacher.ui.homework.AllHomework.adapter
...
class AllHomeworkAdapter(context: Context, homeworkList: HomeworkList) :
    RecyclerView.Adapter<AllHomeworkAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return AllHomeworkAdapter.ViewHolder(inflater)
    }
