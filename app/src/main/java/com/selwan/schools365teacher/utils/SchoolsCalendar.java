package com.selwan.schools365teacher.utils;
...
public class SchoolsCalendar extends LinearLayout {
    ...
    public SchoolsCalendar(Context context) {
        super(context);
        this.context = context;
        onCreateView();
    }

    public SchoolsCalendar(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        if (isInEditMode()) {
            return;
